...
<div class="fixed-sidebar-left">
    <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li>
            <a href="/dataleak/data-leak"><div class="pull-left"><i class="zmdi zmdi-smartphone-info mr-20"></i><span class="right-nav-text">Media Social</span></div><div class="clearfix"></div></a>
        </li> 
        <li><hr class="light-grey-hr mb-10"/></li>
    </ul>
</div>
