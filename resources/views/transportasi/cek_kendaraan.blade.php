                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-8 p-0 m-0">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="vehicleNumber" name="vehicleNumber" class="form-control" placeholder="Enter Vehicle Number Or NIK">
                                </div>
                             </div>
                        </div>
                        <div class="col-sm-4 p-0 m-0">
                            <div class="form-group">
                                <div class="input-group">
                                    <select class="form-control" onchange="changeType()" id="selectTypeKendaraan">
